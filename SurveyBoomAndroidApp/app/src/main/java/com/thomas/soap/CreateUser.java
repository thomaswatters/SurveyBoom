...
public class CreateUser extends AttributeContainer implements KvmSerializable,java.io.Serializable
{
    ...
    public CreateUser (Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
