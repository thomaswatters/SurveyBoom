...
public class GetSurvey extends AttributeContainer implements KvmSerializable,java.io.Serializable
{
    ...
    public GetSurvey (Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        {	
            ...
            if (obj != null && obj.getClass().equals(SoapPrimitive.class))
            {
                ...
                if(j.toString()!=null)
                {
                    this.key = Integer.parseInt(j.toString());
                }
	        }
